...
- Adapter마다 Parameter Injection을 지원할 수 있음
...
class-transformer 개조. 사용자에겐 class-transformer의 DX를 제공. Expose가 기본
...
@Type은 고려해야함. AOT에서 인지할 수 있는 Native 타입을 @Type(() => Number) 식으로 사용하게끔 해야하는가?
...
아래의 기능을 core에서 제공하는건 깔끔하지만 CLI는 글로벌로도 설치되기 때문에 Core를 의존해야하는지 고려해야한다.
