...
-- NOTE: HNSW indexing for pgvector requires a dimensioned vector type (e.g. vector(1536)).
-- This KB keeps embedding dimension flexible for now, so we intentionally skip the index here.
