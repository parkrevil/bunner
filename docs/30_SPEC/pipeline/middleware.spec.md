# Pipeline Middleware Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                                        |
| ---------------- | ------------------------------------------------ |
| Title            | Pipeline Middleware Specification                |
...
| Item                               |
| ---------------------------------- |
| Middleware pipeline stage contract |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| middleware-stage      | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| ------------------------: | --------------------------- | --------------- | ----------------------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------ | --------------------------------- |
| PIPELINE-MIDDLEWARE-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:middleware-stage, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | middleware stage is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | ---------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/pipeline/middleware.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | ------------------------: | ------------------------ | ---------: | ----------------------------- |
| middleware stage declared  | PIPELINE-MIDDLEWARE-R-001 | Artifact:ContractData    |    OUT-001 | middleware stage is checkable |
