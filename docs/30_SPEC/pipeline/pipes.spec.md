# Pipeline Pipes Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                                                                                       |
| ---------------- | ----------------------------------------------------------------------------------------------- |
| Title            | Pipeline Pipes Specification                                                                    |
| ID               | PIPELINE-PIPES                                                                                  |
| Version          | v1                                                                                              |
| Status           | Draft                                                                                           |
| Owner            | repo                                                                                            |
| Uniqueness Scope | spec                                                                                            |
| Depends-On       | path:docs/30_SPEC/adapter/pipeline-shape.spec.md, path:docs/30_SPEC/common/declarations.spec.md |
...
| ------------------------- | ------------------------------------------------ | -------------- |
| source                    | path:docs/30_SPEC/adapter/pipeline-shape.spec.md | pipeline shape |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| pipes-stage           | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |

### 3.2 정적 데이터 형상(Static Data Shapes) (REQUIRED)

```ts
export type Pipe = (...args: any[]) => unknown;
...
| -------------------- | --------------------------- | --------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------- | --------------------------------- |
| PIPELINE-PIPES-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:pipes-stage, Artifact:ContractData, Artifact:Pipe, Shape:local:ContractData, Shape:local:Pipe, Outcome:OUT-001 | pipes stage and Pipe are mechanically checkable | build                             |
...
| Pipe                      | schema             | local:Pipe                 | this-spec-only                     |
...
| ------------------ | ------------------------------- | ----------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/pipeline/pipes.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
| Pipe               | glob                            | docs/30_SPEC/pipeline/pipes.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | -------------------- | ------------------------ | ---------- | ----------------------------- |
| pipes stage declared       | PIPELINE-PIPES-R-001 | Artifact:ContractData    | OUT-001    | pipes stage is checkable      |
...
| -------------------- | ------------------------------ | ------------------------- | ------------------------ | ------------------- | --------------------------------- |
| PIPELINE-PIPES-R-001 | invalid pipes stage            | BUNNER_PIPELINE_PIPES_001 | error                    | symbol              | static:ast                        |
...
| From           | To Document                                      |
| -------------- | ------------------------------------------------ |
| pipeline shape | path:docs/30_SPEC/adapter/pipeline-shape.spec.md |
