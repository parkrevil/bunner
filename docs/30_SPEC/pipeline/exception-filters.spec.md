# Pipeline Exception Filters Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                                        |
| ---------------- | ------------------------------------------------ |
| Title            | Pipeline Exception Filters Specification         |
| ID               | PIPELINE-EXCEPTION-FILTERS                       |
| Version          | v1                                               |
| Status           | Draft                                            |
| Owner            | repo                                             |
| Uniqueness Scope | spec                                             |
| Depends-On       | path:docs/30_SPEC/adapter/pipeline-shape.spec.md |
...
| Item                                      |
| ----------------------------------------- |
| Exception filters pipeline stage contract |
...
| ----------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| exception-filters-stage | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| -------------------------------: | --------------------------- | --------------- | ----------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| PIPELINE-EXCEPTION-FILTERS-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:exception-filters-stage, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | exception filters stage is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | ----------------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/pipeline/exception-filters.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------------- | -------------------------------: | ------------------------ | ---------: | ------------------------------------ |
| exception filters stage declared | PIPELINE-EXCEPTION-FILTERS-R-001 | Artifact:ContractData    |    OUT-001 | exception filters stage is checkable |
...
| -------------------------------: | ------------------------------- | ------------------------------------- | ------------------------ | ------------------- | --------------------------------- |
| PIPELINE-EXCEPTION-FILTERS-R-001 | invalid exception filters stage | BUNNER_PIPELINE_EXCEPTION_FILTERS_001 | error                    | symbol              | static:ast                        |
