# Pipeline Guards Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                                        |
| ---------------- | ------------------------------------------------ |
| Title            | Pipeline Guards Specification                    |
| ID               | PIPELINE-GUARDS                                  |
| Version          | v1                                               |
| Status           | Draft                                            |
| Owner            | repo                                             |
...
| Item                           |
| ------------------------------ |
| Guards pipeline stage contract |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| guards-stage          | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| --------------------: | --------------------------- | --------------- | ----------------------------------- | ---------------------------------------------------------------------------------------- | -------------------------------------- | --------------------------------- |
| PIPELINE-GUARDS-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:guards-stage, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | guards stage is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | ------------------------------------ | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/pipeline/guards.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | --------------------: | ------------------------ | ---------: | ----------------------------- |
| guards stage declared      | PIPELINE-GUARDS-R-001 | Artifact:ContractData    |    OUT-001 | guards stage is checkable     |
...
| --------------------: | ------------------------------ | -------------------------- | ------------------------ | ------------------- | --------------------------------- |
| PIPELINE-GUARDS-R-001 | invalid guards stage           | BUNNER_PIPELINE_GUARDS_001 | error                    | symbol              | static:ast                        |
