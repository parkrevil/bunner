...
| 필드(Field)      | 값(Value)                                        |
| ---------------- | ------------------------------------------------ |
| Title            | Compiler Manifest Specification                  |
| ID               | COMPILER-MANIFEST                                |
| Version          | v1                                               |
| Status           | Draft                                            |
| Owner            | repo                                             |
| Uniqueness Scope | spec                                             |
| Depends-On       | path:docs/30_SPEC/module-system/manifest.spec.md |
...
| Item                                 |
| ------------------------------------ |
| Compiler-produced manifest artifacts |
...
| ------------------------- | ------------------------------------------------ | ----------------- |
| source                    | path:docs/30_SPEC/module-system/manifest.spec.md | manifest contract |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| compiler-manifest     | code (AOT)                | object-literal                  | yes                                   | yes                                         | none                                            |
...
| ----------------------: | --------------------------- | --------------- | ----------------------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------- | --------------------------------- |
| COMPILER-MANIFEST-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:compiler-manifest, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | compiler manifest is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | -------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/compiler/manifest.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | ----------------------: | ------------------------ | ---------: | ------------------------------ |
| compiler manifest declared | COMPILER-MANIFEST-R-001 | Artifact:ContractData    |    OUT-001 | compiler manifest is checkable |
...
| ----------------------: | ------------------------------ | ---------------------------- | ------------------------ | ------------------- | --------------------------------- |
| COMPILER-MANIFEST-R-001 | invalid compiler manifest      | BUNNER_COMPILER_MANIFEST_001 | error                    | symbol              | static:ast                        |
...
| From              | To Document                                      |
| ----------------- | ------------------------------------------------ |
| manifest contract | path:docs/30_SPEC/module-system/manifest.spec.md |
