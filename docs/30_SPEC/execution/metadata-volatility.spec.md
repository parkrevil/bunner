# Execution Metadata Volatility Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                                     |
| ---------------- | --------------------------------------------- |
| Title            | Execution Metadata Volatility Specification   |
| ID               | EXECUTION-METADATA-VOLATILITY                 |
| Version          | v1                                            |
| Status           | Draft                                         |
| Owner            | repo                                          |
| Uniqueness Scope | spec                                          |
| Depends-On       | path:docs/30_SPEC/execution/execution.spec.md |
...
| ------------------------- | --------------------------------------------- | ------------------ |
| source                    | path:docs/30_SPEC/execution/execution.spec.md | execution contract |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| metadata-volatility   | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| ----------------------------------: | --------------------------- | --------------- | ----------------------------------- | ----------------------------------------------------------------------------------------------- | ------------------------------------------- | --------------------------------- |
| EXECUTION-METADATA-VOLATILITY-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:metadata-volatility, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | volatility rules are mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | -------------------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/execution/metadata-volatility.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | ----------------------------------: | ------------------------ | ---------: | -------------------------------- |
| volatility rules declared  | EXECUTION-METADATA-VOLATILITY-R-001 | Artifact:ContractData    |    OUT-001 | metadata volatility is checkable |
...
| ----------------------------------: | ------------------------------ | ---------------------------------------- | ------------------------ | ------------------- | --------------------------------- |
| EXECUTION-METADATA-VOLATILITY-R-001 | invalid metadata volatility    | BUNNER_EXECUTION_METADATA_VOLATILITY_001 | error                    | symbol              | static:ast                        |
...
| From               | To Document                                   |
| ------------------ | --------------------------------------------- |
| execution contract | path:docs/30_SPEC/execution/execution.spec.md |
