# Execution Normal Flow Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                                     |
| ---------------- | --------------------------------------------- |
| Title            | Execution Normal Flow Specification           |
| ID               | EXECUTION-NORMAL-FLOW                         |
| Version          | v1                                            |
| Status           | Draft                                         |
| Owner            | repo                                          |
...
| Item                           |
| ------------------------------ |
| Normal execution flow contract |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| normal-flow           | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| --------------------------: | --------------------------- | --------------- | ----------------------------------- | --------------------------------------------------------------------------------------- | -------------------------------------- | --------------------------------- |
| EXECUTION-NORMAL-FLOW-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:normal-flow, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | normal flow is mechanically checkable  | build                             |
...
| ------------------ | ------------------------------- | ------------------------------------------ | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/execution/normal-flow.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | --------------------------: | ------------------------ | ---------: | ----------------------------- |
| normal flow declared       | EXECUTION-NORMAL-FLOW-R-001 | Artifact:ContractData    |    OUT-001 | normal flow is checkable      |
