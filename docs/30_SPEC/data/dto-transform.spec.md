# DTO Transform Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                          |
| ---------------- | ---------------------------------- |
| Title            | DTO Transform Specification        |
| ID               | DTO-TRANSFORM                      |
| Version          | v1                                 |
| Status           | Draft                              |
| Owner            | repo                               |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| dto-transform         | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| ------------------: | --------------------------- | --------------- | ----------------------------------- | ----------------------------------------------------------------------------------------- | --------------------------------------- | --------------------------------- |
| DTO-TRANSFORM-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:dto-transform, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | DTO transform is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | --------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/data/dto-transform.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | ------------------: | ------------------------ | ---------: | ----------------------------- |
| DTO transform declared     | DTO-TRANSFORM-R-001 | Artifact:ContractData    |    OUT-001 | DTO transform is checkable    |
