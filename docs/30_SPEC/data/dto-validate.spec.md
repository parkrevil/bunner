# DTO Validate Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                          |
| ---------------- | ---------------------------------- |
| Title            | DTO Validate Specification         |
| ID               | DTO-VALIDATE                       |
| Version          | v1                                 |
| Status           | Draft                              |
| Owner            | repo                               |
| Uniqueness Scope | spec                               |
| Depends-On       | path:docs/30_SPEC/data/dto.spec.md |
...
| ------------------------- | ---------------------------------- | ------------- |
| source                    | path:docs/30_SPEC/data/dto.spec.md | DTO contract  |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| dto-validate          | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| -----------------: | --------------------------- | --------------- | ----------------------------------- | ---------------------------------------------------------------------------------------- | ---------------------------------------- | --------------------------------- |
| DTO-VALIDATE-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:dto-validate, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | DTO validation is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | -------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/data/dto-validate.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | -----------------: | ------------------------ | ---------: | ----------------------------- |
| DTO validation declared    | DTO-VALIDATE-R-001 | Artifact:ContractData    |    OUT-001 | DTO validation is checkable   |
...
| -----------------: | ------------------------------ | ----------------------- | ------------------------ | ------------------- | --------------------------------- |
| DTO-VALIDATE-R-001 | invalid DTO validation         | BUNNER_DTO_VALIDATE_001 | error                    | symbol              | static:ast                        |
...
| From         | To Document                        |
| ------------ | ---------------------------------- |
| DTO contract | path:docs/30_SPEC/data/dto.spec.md |
