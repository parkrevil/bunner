...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| dto-schema            | code (AOT)                | type-level                      | yes                                   | yes                                         | none                                            |
...
| ---------------: | --------------------------- | --------------- | ----------------------------------- | -------------------------------------------------------------------------------------- | -------------------------------------- | --------------------------------- |
| DTO-SCHEMA-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:dto-schema, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | DTO schema is mechanically checkable   | build                             |
...
| ------------------ | ------------------------------- | ------------------------------------ | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/data/dto-schema.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | ---------------: | ------------------------ | ---------: | ----------------------------- |
| DTO schema declared        | DTO-SCHEMA-R-001 | Artifact:ContractData    |    OUT-001 | DTO schema is checkable       |
...
| ---------------: | ------------------------------ | --------------------- | ------------------------ | ------------------- | --------------------------------- |
| DTO-SCHEMA-R-001 | invalid DTO schema             | BUNNER_DTO_SCHEMA_001 | error                    | symbol              | static:ast                        |
