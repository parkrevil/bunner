...
| 필드(Field) | 값(Value) |
| --- | --- |
| Title | Define Module Specification |
| ID | DEFINE-MODULE |
| Version | v1 |
| Status | Draft |
| Owner | repo |
| Uniqueness Scope | spec |
| Depends-On | path:docs/30_SPEC/common/declarations.spec.md, path:docs/30_SPEC/common/diagnostics.spec.md |
...
| Item |
| --- |
| defineModule 호출 수집 및 정적 제약(AOT) |
| module marker export 형태 제약 |
| 모듈 파일당 defineModule 호출 횟수 제약 |
...
| --- | --- | --- | --- | --- | --- |
| define-module | code (AOT) | call-expression | yes | yes | none |
...
| --- | --- | --- | --- |
| DefineModuleCall | schema | local:DefineModuleCall | this-spec-only |
...
| --- | --- | --- | --- | --- | --- | --- |
| DefineModuleCall | glob | docs/30_SPEC/module-system/define-module.spec.md | build | n/a | n/a | n/a |
...
| --- | --- | --- | --- | --- |
| defineModule call exists | DEFINE-MODULE-R-001 | InputKind:define-module | OUT-001 | module marker declaration is collectable |
| module marker export observed | DEFINE-MODULE-R-002 | Outcome:OUT-002 | OUT-002 | export form is mechanically decidable |
| module file processed | DEFINE-MODULE-R-003 | Outcome:OUT-003 | OUT-003 | multiple defineModule calls are rejected |
...
| From | To Document |
| --- | --- |
| defineModule | path:docs/30_SPEC/app/app.spec.md |
