...
| 필드(Field)      | 값(Value)                                                                                                                                                                                                                                     |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Title            | Module System Specification                                                                                                                                                                                                                   |
| ID               | MODULE-SYSTEM                                                                                                                                                                                                                                 |
| Version          | v1                                                                                                                                                                                                                                            |
| Status           | Draft                                                                                                                                                                                                                                         |
| Owner            | repo                                                                                                                                                                                                                                          |
| Uniqueness Scope | repo                                                                                                                                                                                                                                          |
| Depends-On       | path:docs/30_SPEC/common/identity.spec.md, path:docs/30_SPEC/common/diagnostics.spec.md, path:docs/30_SPEC/compiler/aot-ast.spec.md, path:docs/30_SPEC/module-system/boundary.spec.md, path:docs/30_SPEC/module-system/adapter-config.spec.md |
...
| 프로젝트 루트/모듈 루트 판정                       |
| 모듈 이름/ID 정규화                                |
| 모듈 루트 파일의 AdapterConfig/dependsOn 수집/검증 |
...
| ------------------------- | ------------------------------------------------------ | ---------------------- |
| dependency                | path:docs/30_SPEC/common/identity.spec.md              | AdapterId/AdapterName  |
| dependency                | path:docs/30_SPEC/common/diagnostics.spec.md           | build-time diagnostics |
| dependency                | path:docs/30_SPEC/module-system/boundary.spec.md       | module boundary        |
| dependency                | path:docs/30_SPEC/module-system/adapter-config.spec.md | AdapterConfig          |
...
```ts
export type ModuleSystemData = unknown;
```
...
| MODULE-SYSTEM-R-002 | active                      | MUST            | inputs                              | InputKind:adapter-config                                                                            | dependsOn normalization is deterministic and validated | build                             |
...
| ------------------------- | ------------------ | -------------------------- | ---------------------------------- |
| ModuleSystemData          | schema             | local:ModuleSystemData     | this-spec-only                     |
...
| ------------------ | ------------------------------- | ------------------------------------------------ | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ModuleSystemData   | glob                            | docs/30_SPEC/module-system/module-system.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| ---------------------------------- | ----------------------------------------- | ------------- | --------------- | ------------------------- | --------------------------------------------- |
| module-system-depends-on-adapterid | Artifact:AdapterId                        | allowed       | forbidden       | lint                      | n/a                                           |
...
| --------------------------------- | ------------------- | ------------------------- | ---------- | ----------------------------------------------- |
| given fs + config                 | MODULE-SYSTEM-R-001 | InputKind:module-fileName | OUT-001    | module roots are identified deterministically   |
| adapter config contains dependsOn | MODULE-SYSTEM-R-002 | InputKind:adapter-config  | OUT-002    | invalid adapterId or cycle yields build failure |
...
| From                  | To Document                                      |
| --------------------- | ------------------------------------------------ |
| 모듈 판정 결과 직렬화 | path:docs/30_SPEC/module-system/manifest.spec.md |
