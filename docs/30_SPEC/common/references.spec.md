# Common References Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                               |
| ---------------- | --------------------------------------- |
| Title            | Common References Specification         |
...
| Item                                       |
| ------------------------------------------ |
| Reference string conventions (file#symbol) |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| reference-string      | code (AOT)                | string-literal                  | yes                                   | yes                                         | none                                            |
...
| ----------------------- | --------------------------- | --------------- | ----------------------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------- |
| COMMON-REFERENCES-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:reference-string, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | reference string MUST match ^[^#\\s]+#[A-Za-z\_$][A-Za-z0-9_$]_$; file part MUST be normalized project-root-relative path (uses / separators; does not start with /; contains no whitespace; contains no .. segment); symbol part MUST match ^[A-Za-z_$][A-Za-z0-9_$]\_$ | build                             |
...
| ------------------ | ------------------------------- | -------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/common/references.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | ----------------------- | ------------------------ | ---------- | ----------------------------- |
| reference strings exist    | COMMON-REFERENCES-R-001 | Artifact:ContractData    | OUT-001    | reference format is checkable |
