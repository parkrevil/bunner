# Provider Scope Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                                   |
| ---------------- | ------------------------------------------- |
| Title            | Provider Scope Specification                |
| ID               | PROVIDER-SCOPE                              |
| Version          | v1                                          |
| Status           | Draft                                       |
| Owner            | repo                                        |
| Uniqueness Scope | spec                                        |
| Depends-On       | path:docs/30_SPEC/provider/provider.spec.md |
...
| ------------------------- | ------------------------------------------- | ----------------- |
| source                    | path:docs/30_SPEC/provider/provider.spec.md | provider contract |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| provider-scope        | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| -------------------: | --------------------------- | --------------- | ----------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------- | --------------------------------- |
| PROVIDER-SCOPE-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:provider-scope, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | provider scope is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | ----------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/provider/scope.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | -------------------: | ------------------------ | ---------: | ----------------------------- |
| provider scope declared    | PROVIDER-SCOPE-R-001 | Artifact:ContractData    |    OUT-001 | provider scope is checkable   |
...
| -------------------: | ------------------------------ | ------------------------- | ------------------------ | ------------------- | --------------------------------- |
| PROVIDER-SCOPE-R-001 | invalid provider scope         | BUNNER_PROVIDER_SCOPE_001 | error                    | symbol              | static:ast                        |
...
| From              | To Document                                 |
| ----------------- | ------------------------------------------- |
| provider contract | path:docs/30_SPEC/provider/provider.spec.md |
