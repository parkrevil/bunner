...
| 필드(Field)      | 값(Value)                                   |
| ---------------- | ------------------------------------------- |
| Title            | Provider Lifecycle Specification            |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| provider-lifecycle    | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| -----------------------: | --------------------------- | --------------- | ----------------------------------- | ---------------------------------------------------------------------------------------------- | -------------------------------------------- | --------------------------------- |
| PROVIDER-LIFECYCLE-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:provider-lifecycle, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | provider lifecycle is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | --------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/provider/lifecycle.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| --------------------------- | -----------------------: | ------------------------ | ---------: | ------------------------------- |
| provider lifecycle declared | PROVIDER-LIFECYCLE-R-001 | Artifact:ContractData    |    OUT-001 | provider lifecycle is checkable |
