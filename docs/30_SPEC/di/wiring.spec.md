# DI Wiring Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                       |
| ---------------- | ------------------------------- |
| Title            | DI Wiring Specification         |
| ID               | DI-WIRING                       |
| Version          | v1                              |
| Status           | Draft                           |
| Owner            | repo                            |
| Uniqueness Scope | spec                            |
| Depends-On       | path:docs/30_SPEC/di/di.spec.md |
...
| Item                            |
| ------------------------------- |
| Module wiring into DI container |
...
| ------------------------- | ------------------------------- | ------------- |
| source                    | path:docs/30_SPEC/di/di.spec.md | DI contract   |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| module-wiring         | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| --------------: | --------------------------- | --------------- | ----------------------------------- | ----------------------------------------------------------------------------------------- | --------------------------------------- | --------------------------------- |
| DI-WIRING-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:module-wiring, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | module wiring is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | ------------------------------ | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/di/wiring.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | --------------: | ------------------------ | ---------: | -------------------------------- |
| module wiring exists       | DI-WIRING-R-001 | Artifact:ContractData    |    OUT-001 | wiring constraints are checkable |
...
| From        | To Document                     |
| ----------- | ------------------------------- |
| DI contract | path:docs/30_SPEC/di/di.spec.md |
