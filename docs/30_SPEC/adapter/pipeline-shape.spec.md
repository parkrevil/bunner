# Adapter Pipeline Shape Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                                 |
| ---------------- | ----------------------------------------- |
| Title            | Adapter Pipeline Shape Specification      |
| ID               | ADAPTER-PIPELINE-SHAPE                    |
| Version          | v1                                        |
| Status           | Draft                                     |
| Owner            | repo                                      |
...
| Item                                                      |
| --------------------------------------------------------- |
| Pipeline (middleware/guards/pipes/filters) shape contract |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| pipeline-shape        | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| ---------------------------: | --------------------------- | --------------- | ----------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------- | --------------------------------- |
| ADAPTER-PIPELINE-SHAPE-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:pipeline-shape, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | pipeline shape is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | ------------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/adapter/pipeline-shape.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | ---------------------------: | ------------------------ | ---------: | ----------------------------- |
| pipeline shape declared    | ADAPTER-PIPELINE-SHAPE-R-001 | Artifact:ContractData    |    OUT-001 | pipeline shape is checkable   |
