# Adapter Middleware Phase Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                                 |
| ---------------- | ----------------------------------------- |
| Title            | Adapter Middleware Phase Specification    |
| ID               | ADAPTER-MIDDLEWARE-PHASE                  |
| Version          | v1                                        |
| Status           | Draft                                     |
| Owner            | repo                                      |
...
| Item                              |
| --------------------------------- |
| Adapter middleware phase contract |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| adapter-mw-phase      | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| -----------------------------: | --------------------------- | --------------- | ----------------------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------ | --------------------------------- |
| ADAPTER-MIDDLEWARE-PHASE-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:adapter-mw-phase, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | middleware phase is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | --------------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/adapter/middleware-phase.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | -----------------------------: | ------------------------ | ---------: | ----------------------------- |
| middleware phase declared  | ADAPTER-MIDDLEWARE-PHASE-R-001 | Artifact:ContractData    |    OUT-001 | middleware phase is checkable |
...
| -----------------------------: | ------------------------------ | ----------------------------------- | ------------------------ | ------------------- | --------------------------------- |
| ADAPTER-MIDDLEWARE-PHASE-R-001 | invalid middleware phase       | BUNNER_ADAPTER_MIDDLEWARE_PHASE_001 | error                    | symbol              | static:ast                        |
