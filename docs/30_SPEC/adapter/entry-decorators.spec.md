# Adapter Entry Decorators Specification

## 0. 정체성(Identity) (REQUIRED)

| 필드(Field)      | 값(Value)                                 |
| ---------------- | ----------------------------------------- |
| Title            | Adapter Entry Decorators Specification    |
| ID               | ADAPTER-ENTRY-DECORATORS                  |
| Version          | v1                                        |
| Status           | Draft                                     |
| Owner            | repo                                      |
| Uniqueness Scope | spec                                      |
| Depends-On       | path:docs/30_SPEC/adapter/adapter.spec.md |
...
| Item                                |
| ----------------------------------- |
| Adapter entry decorators collection |
...
| ------------------------- | ----------------------------------------- | ---------------- |
| source                    | path:docs/30_SPEC/adapter/adapter.spec.md | adapter contract |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| entry-decorators      | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| -----------------------------: | --------------------------- | --------------- | ----------------------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------- | --------------------------------- |
| ADAPTER-ENTRY-DECORATORS-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:entry-decorators, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | entry decorators are mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | --------------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/adapter/entry-decorators.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | -----------------------------: | ------------------------ | ---------: | ------------------------------ |
| entry decorators exist     | ADAPTER-ENTRY-DECORATORS-R-001 | Artifact:ContractData    |    OUT-001 | entry decorators are checkable |
...
| -----------------------------: | ------------------------------ | ----------------------------------- | ------------------------ | ------------------- | --------------------------------- |
| ADAPTER-ENTRY-DECORATORS-R-001 | invalid entry decorators       | BUNNER_ADAPTER_ENTRY_DECORATORS_001 | error                    | symbol              | static:ast                        |
...
| From             | To Document                               |
| ---------------- | ----------------------------------------- |
| adapter contract | path:docs/30_SPEC/adapter/adapter.spec.md |
