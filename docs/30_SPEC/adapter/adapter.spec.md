...
| middlewarePhaseOrder      | AdapterRegistrationInput                                 | array-literal                   | yes                                   | yes                                         | none                                            |
| supportedMiddlewarePhases | AdapterRegistrationInput                                 | object-literal                  | yes                                   | yes                                         | none                                            |
| decorators                | AdapterRegistrationInput                                 | object-literal                  | yes                                   | yes                                         | none                                            |
| middlewarePhaseId         | pipeline + middlewarePhaseOrder + decorator declarations | phase-id-token                  | no                                    | yes                                         | string-id                                       |
...
| ------------------------------ | ------------- | --------------------------- | --------------------------------------------------------------------------- | ---------------------------------------------- | --------------------------------- |
| string-id                      | ADAPTER-R-005 | InputKind:middlewarePhaseId | normalized MiddlewarePhaseId is a non-empty string and MUST NOT contain ":" | deterministic, stable                          | build                             |
...
| ADAPTER-R-002 | active                      | MUST            | artifacts, shapes, outcomes | Artifact:AdapterContract; Shape:local:AdapterContractData; Shape:local:AdapterRegistrationInput; Outcome:OUT-002 | AdapterRegistrationInput has statically decidable fields classRef/pipeline/middlewarePhaseOrder/supportedMiddlewarePhases/decorators                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | build                             |
| ADAPTER-R-003 | active                      | MUST            | inputs, outcomes            | InputKind:classRef; Outcome:OUT-003                                                                              | classRef resolves to a concrete (non-abstract) class that extends BunnerAdapter                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | build                             |
| ADAPTER-R-004 | active                      | MUST            | inputs, outcomes            | InputKind:pipeline; Outcome:OUT-004                                                                              | pipeline is an array literal of PipelineToken and contains exactly one Handler token; Guards/Pipes appear at most once; reserved tokens are not expressed as string literals                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | build                             |
| ADAPTER-R-005 | active                      | MUST            | inputs, outcomes            | InputKind:middlewarePhaseId; Outcome:OUT-005                                                                     | MiddlewarePhaseId normalization is deterministic: string literal stays identical; symbol reference normalizes to "file#symbol" and never contains ":"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | build                             |
| ADAPTER-R-006 | active                      | MUST            | inputs, outcomes            | InputKind:middlewarePhaseOrder; InputKind:supportedMiddlewarePhases; Outcome:OUT-006                             | middlewarePhaseOrder is non-empty and has no duplicates after normalization; supportedMiddlewarePhases is non-empty and its key set equals the middlewarePhaseOrder element set                                                                                                                                                                                                                                                                                                                                                                                                                                                                | build                             |
| ADAPTER-R-007 | active                      | MUST            | inputs, outcomes            | InputKind:pipeline; InputKind:middlewarePhaseOrder; Outcome:OUT-007                                              | pipeline contains every middlewarePhaseOrder phase id exactly once and preserves the middlewarePhaseOrder relative order                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | build                             |
| ADAPTER-R-008 | active                      | MUST            | outcomes                    | Outcome:OUT-008                                                                                                  | middleware placement uses middlewarePhaseOrder order and preserves declaration order within the same phase; unknown phase id yields build failure                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | build                             |
...
| classRef resolved            | ADAPTER-R-003 | InputKind:classRef                 | OUT-003    | classRef is a concrete BunnerAdapter subclass                       |
| pipeline collected           | ADAPTER-R-004 | InputKind:pipeline                 | OUT-004    | pipeline tokens and reserved token constraints are satisfied        |
| phase id normalized          | ADAPTER-R-005 | InputKind:middlewarePhaseId        | OUT-005    | MiddlewarePhaseId normalization is stable                           |
| phase sets validated         | ADAPTER-R-006 | InputKind:middlewarePhaseOrder     | OUT-006    | phase order and supported set are consistent                        |
| pipeline ordered             | ADAPTER-R-007 | InputKind:pipeline                 | OUT-007    | pipeline phase ids match and follow middlewarePhaseOrder            |
...
| ------------- | -------------------------------------------------------------- | ------------------ | ------------------------ | ------------------- | --------------------------------- |
| ADAPTER-R-001 | adapterSpec 수집 실패 또는 defineAdapter 입력 위반             | BUNNER_ADAPTER_001 | error                    | file                | static:ast                        |
| ADAPTER-R-002 | AdapterRegistrationInput 필드 수집/판정 불가                   | BUNNER_ADAPTER_002 | error                    | file                | static:ast                        |
| ADAPTER-R-003 | classRef가 BunnerAdapter를 상속하지 않거나 abstract class      | BUNNER_ADAPTER_003 | error                    | symbol              | static:ast                        |
| ADAPTER-R-004 | pipeline 토큰 형상/예약 토큰 규칙 위반                         | BUNNER_ADAPTER_004 | error                    | file                | static:ast                        |
| ADAPTER-R-005 | MiddlewarePhaseId 정규화 규칙 위반                             | BUNNER_ADAPTER_005 | error                    | symbol              | static:ast                        |
| ADAPTER-R-006 | middlewarePhaseOrder/supportedMiddlewarePhases 불일치          | BUNNER_ADAPTER_006 | error                    | file                | static:ast                        |
| ADAPTER-R-007 | pipeline phase id 순서/대응 불일치                             | BUNNER_ADAPTER_007 | error                    | file                | static:ast                        |
| ADAPTER-R-008 | middleware 배치 결정 불가 또는 지원하지 않는 phase id 사용     | BUNNER_ADAPTER_008 | error                    | file                | static:artifact                   |
| ADAPTER-R-009 | exception filter chain 구성 결정 불가 또는 dedupe 발생         | BUNNER_ADAPTER_009 | error                    | file                | static:artifact                   |
| ADAPTER-R-010 | entry decorator 사용/수집 규칙 위반                            | BUNNER_ADAPTER_010 | error                    | file                | static:ast                        |
| ADAPTER-R-011 | handler 선택이 HandlerId로 결정 불가 또는 core로 라우팅을 위임 | BUNNER_ADAPTER_011 | error                    | range               | runtime:observation               |
| ADAPTER-R-012 | middleware Error 이후 Guards/Pipes/Handler 실행이 관측됨       | BUNNER_ADAPTER_012 | error                    | range               | runtime:observation               |
