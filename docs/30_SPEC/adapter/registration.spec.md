...
| 필드(Field)      | 값(Value)                                 |
| ---------------- | ----------------------------------------- |
| Title            | Adapter Registration Specification        |
...
| Item                              |
| --------------------------------- |
| Adapter registration into runtime |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| adapter-registration  | code (AOT)                | ast-form                        | yes                                   | yes                                         | none                                            |
...
| -------------------------: | --------------------------- | --------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------ | ---------------------------------------------- | --------------------------------- |
| ADAPTER-REGISTRATION-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:adapter-registration, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | adapter registration is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | ----------------------------------------- | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/adapter/registration.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| --------------------------- | -------------------------: | ------------------------ | ---------: | --------------------------------- |
| adapter registration exists | ADAPTER-REGISTRATION-R-001 | Artifact:ContractData    |    OUT-001 | adapter registration is checkable |
