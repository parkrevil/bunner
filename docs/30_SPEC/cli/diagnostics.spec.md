...
| 필드(Field)      | 값(Value)                                    |
| ---------------- | -------------------------------------------- |
| Title            | CLI Diagnostics Specification                |
| ID               | CLI-DIAGNOSTICS                              |
| Version          | v1                                           |
| Status           | Draft                                        |
| Owner            | repo                                         |
...
| Item                             |
| -------------------------------- |
| CLI surface diagnostics emission |
...
| ------------------------- | -------------------------------------------- | -------------------- |
| source                    | path:docs/30_SPEC/common/diagnostics.spec.md | diagnostics contract |
...
| --------------------- | ------------------------- | ------------------------------- | ------------------------------------- | ------------------------------------------- | ----------------------------------------------- |
| cli-diag-output       | code (AOT)                | string-literal                  | yes                                   | yes                                         | none                                            |
...
| --------------------: | --------------------------- | --------------- | ----------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------ | --------------------------------- |
| CLI-DIAGNOSTICS-R-001 | active                      | MUST            | inputs, artifacts, shapes, outcomes | InputKind:cli-diag-output, Artifact:ContractData, Shape:local:ContractData, Outcome:OUT-001 | CLI diagnostics output is mechanically checkable | build                             |
...
| ------------------ | ------------------------------- | ------------------------------------ | ------------------------- | --------------------------------------------- | ------------------------------------------------- | --------------------------------- |
| ContractData       | glob                            | docs/30_SPEC/cli/diagnostics.spec.md | build                     | n/a                                           | n/a                                               | n/a                               |
...
| -------------------------- | --------------------: | ------------------------ | ---------: | ----------------------------- |
| CLI emits diagnostics      | CLI-DIAGNOSTICS-R-001 | Artifact:ContractData    |    OUT-001 | CLI diagnostics are checkable |
...
| From                 | To Document                                  |
| -------------------- | -------------------------------------------- |
| diagnostics contract | path:docs/30_SPEC/common/diagnostics.spec.md |
